...
HD_PWD='C:/Users/Primus/Desktop/Schule/Spring2020/CSCE836/Homework/csce_436_clark/design_debugger/design_debugger.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log testlab.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source testlab.tcl -notrace
