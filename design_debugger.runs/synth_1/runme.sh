...
HD_PWD='C:/Users/Primus/Desktop/Schule/Spring2020/CSCE836/Homework/csce_436_clark/design_debugger/design_debugger.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testlab.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testlab.tcl
